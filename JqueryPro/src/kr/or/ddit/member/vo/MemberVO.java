...
public class MemberVO {
	...
	public String getMemMemorialType() {
		return memMemorialType;
	}
	...
	public void setMemMemorialType(String memMemorialType) {
		this.memMemorialType = memMemorialType;
	}
	...
	public String toString() {
		return "MemberVO [memId=" + memId + ", memPass=" + memPass + ", memName=" + memName + ", memBir=" + memBir
				...
				+ ", memMail=" + memMail + ", recvEmailYn=" + recvEmailYn + ", memJob=" + memJob + ", memLike="
